  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        >
          Let’s collaborate to turn your ideas into reality. KarFamSoft Agency
          is ready to build with you.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <Link
            to="/contact"
            aria-label="Start a Project with KarFamSoft Agency"
          >
            <button className="inline-block bg-gradient-to-r from-white via-indigo-100 to-purple-200 text-indigo-700 font-semibold px-8 py-4 rounded-full shadow-lg hover:from-indigo-200 hover:to-purple-300 hover:text-indigo-900 transition text-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
              Start a Project
            </button>
          </Link>
        </motion.div>
