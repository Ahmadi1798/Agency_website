...
const ServicesCTA = () => {
  return (
    <motion.section
      className="relative py-20 px-6 bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700 dark:from-indigo-800 dark:via-purple-800 dark:to-indigo-700 text-white overflow-hidden"
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        >
          Whether you need a complete digital overhaul or a small strategic
          shift, KarFamSoft Agency is ready to collaborate.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
